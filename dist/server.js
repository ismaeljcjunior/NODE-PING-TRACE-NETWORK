...
var require_main = __commonJS({
  "node_modules/dotenv/lib/main.js"(exports, module2) {
    ...
    module2.exports._configDotenv = DotenvModule._configDotenv;
...
var getIps = async () => {
  const listIp = await prisma2.$queryRawUnsafe(`SELECT * FROM networktracker.host`);
  return listIp;
};
...
var date3 = (0, import_moment3.default)();
app2.use(appRoutes);
var main = async () => {
  const dateFormat2 = date3.format("HH:mm:ss:mm DD/MM/YYYY ");
  try {
    console.log("Run main:", dateFormat2);
    await runPingMain();
  } catch (err) {
    console.log(`Error: ${err}`);
  }
};
var job = import_node_schedule.default.scheduleJob("0-59/15 * * * * *", () => {
  main();
});
app2.listen(port, () => {
